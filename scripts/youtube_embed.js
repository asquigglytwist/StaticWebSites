...
MSN.fnLoadYoutubeVidOnPreviewClick = function (id, w ,h) {
	...
	{
		var sWatchUrl = "https://www.youtube.com/watch?v=" + id;
		window.open(sWatchUrl, "_blank").focus();
	}
}